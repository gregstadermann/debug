...
module.exports = {
    aliases: ['createrm'],
    usage: 'createroom <originRoomId> <direction> <newRoomId>',
    ...
    command: (state) => (args, player) => {
        ...
        let [ originRoomId, newExitDirection, newRoomId ] = args.split(' ');
        ...
        for (let i = 0; i < jsonRoomsObject.length; i++) {
            if(jsonRoomsObject[i].id === originRoomId) {
